...
public:
    YOLO11Detector(std::shared_ptr<Ort::Env> env, const std::string& model_path, bool use_gpu, const cv::Size& input_size, const std::vector<size_t>& warmup_batch_sizes = {});
